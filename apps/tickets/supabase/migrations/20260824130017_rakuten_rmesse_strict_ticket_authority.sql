...
-- Forward recovery: restore the prior function only after a reviewed creation-authority design.
...
BEGIN
  ...
  IF NOT FOUND THEN
    RETURN jsonb_build_object(
      ...
      'messages_inserted', 0,
      'customer_messages_inserted', 0,
      'skipped_reason', 'manual_ticket_creation_required'
    );
  END IF;
